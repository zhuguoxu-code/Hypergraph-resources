...
***
### IEEE Xplore<br>
* HyperKAN: Hypergraph Representation Learning with Kolmogorov-Arnold Networks(ICASSP,2025)[**paper**](https://ieeexplore.ieee.org/document/10889520)<br>
...
* Inhomogeneous Interest Modeling via Hypergraph Convolutional Networks for Social Recommendation(IJCNN,2024)[**paper**](https://ieeexplore.ieee.org/document/10651102)<br>
* Dynamical Attention Hypergraph Convolutional Network for Group Activity Recognition群体活动(TNNLS,2024)[**paper**](https://ieeexplore.ieee.org/document/10613468)<br>
...
* A Multi-Modal Hypergraph Neural Network via Parametric Filtering and Feature Sampling(TBDATA,2023)[**paper**](https://ieeexplore.ieee.org/document/10130646)<br>
* SHG: Self-Supervised Hypergraph Gate Networks for Enhanced Multi-Modal Representation(ACAIT,2023)[**paper**](https://ieeexplore.ieee.org/document/10528492)<br>
* A General Heterogeneous Hypergraph Neural Network for Node Classification(IJCNN,2023)[**paper**](https://ieeexplore.ieee.org/document/10191131)<br>
* EFBH: Collaborative Filtering Model Based on Multi-Hypergraph Encoder(TCE,2023)[**paper**](https://ieeexplore.ieee.org/document/10265223)<br>
* HGNN+: General Hypergraph Neural Networks (TPAMI, 2022)[**paper**](https://ieeexplore.ieee.org/document/9795251)<br>
* Self-supervised Hypergraph Representation Learning(BigData,2022)[**paper**](https://ieeexplore.ieee.org/document/10020240)<br>
...
* Physics-Guided Hypergraph Contrastive Learning for Dynamic Hyperedge Prediction(TNSE,2024)[**paper**](https://ieeexplore.ieee.org/document/10759854)<br>
* Hypergraph Contrastive Learning with Graph Structure Learning for Recommendation(ICMLA,2024)[**paper**](https://ieeexplore.ieee.org/document/10903336)<br>
* CINA: Curvature-Based Integrated Network Alignment with Hypergraph(ICDE,2024)[**paper**](https://ieeexplore.ieee.org/document/10598068)<br>
* Dual-Channel Adaptive Scale Hypergraph Encoders With Cross-View Contrastive Learning for Knowledge Tracing(TNNLS,2024)[**paper**](https://ieeexplore.ieee.org/document/10506993)<br>
* Learning from Heterogeneity: A Dynamic Learning Framework for Hypergraphs(TAI,2024)[**paper**](https://ieeexplore.ieee.org/document/10820547)<br>
* Hypergraph Transformer for Semi-Supervised Classification(ICASSP,2024)[**paper**](https://ieeexplore.ieee.org/document/10446248)<br>
* HGT: Transformer Architecture for Arbitrary Hypergraphs Based on P-Laplacian(IJCNN,2024)[**paper**](https://ieeexplore.ieee.org/document/10650472)<br>
* Hypergraph-Enhanced Self-Supervised Robust Graph Learning for Social Recommendation(ICASSP,2024)[**paper**](https://ieeexplore.ieee.org/document/10448250)<br>
* Hypergraph-Mlp: Learning on Hypergraphs Without Message Passing(ICASSP,2024)[**paper**](https://ieeexplore.ieee.org/document/10446277)<br>
* A Recommendation Method Based on Multi-Source Heterogeneous Hypergraphs and Contrastive Learning对比学习(ACCESS,2024)[**paper**](https://ieeexplore.ieee.org/document/10522682)<br>
...
* Self-Supervised Nodes-Hyperedges Embedding for Heterogeneous Information Network Learning(TBDATA,2023)[**paper**](https://ieeexplore.ieee.org/document/10123057)<br>
* Cell Attention Networks(IJCNN,2023)[**paper**](https://ieeexplore.ieee.org/document/10191530)<br>
* Hypergraph Attribute Attention Network for Community Recommendation(ICDM,2023)[**paper**](https://ieeexplore.ieee.org/document/10415770)<br>
...
* JORA: Weakly Supervised User Identity Linkage via Jointly Learning to Represent and Align(TNNLS,2022)[**paper**](https://ieeexplore.ieee.org/document/9873891)<br>
* SHCN: Self-supervised General Hypergraph Clustering Network聚类任务(BigData,2022)[**paper**](https://ieeexplore.ieee.org/document/10020643)<br>
* Data Representation by Joint Hypergraph Embedding and Sparse Coding (TKDE, 2022)[**paper**](https://ieeexplore.ieee.org/document/9141415)<br><br>
...
* Enhancing Session-Based Recommendation with Hypergraph Motifs and Contrastive Learning对比学习(ICASSP,2025)[**paper**](https://ieeexplore.ieee.org/document/10890368)<br>
* Heterogeneous Hypergraph Structure Learning for Multimedia Recommendation异构(ICME,2024)[**paper**](https://ieeexplore.ieee.org/document/10687948)<br>
...
* Session-Based Recommendation of Self-Supervised Hypergraph Convolutional Networks Incorporating Self-Attention会话推荐(DDCLS,2024)[**paper**](https://ieeexplore.ieee.org/document/10606919)<br>
* Sequential Patterns Unveiled: A Novel Hypergraph Convolution Approach for Dynamic User Preference Analysis(IJCNN,2024)[**paper**](https://ieeexplore.ieee.org/document/10650082)<br>
* A Hypergraph Framework Based on Neighborhood and Category Association Relationships for Session-Based Recommendation(2023)[**paper**](https://ieeexplore.ieee.org/document/10361370)<br>
...
* Multi-Order Hypergraph Convolutional Neural Network for Dynamic Social Recommendation System(ACCESS,2022)[**paper**](https://ieeexplore.ieee.org/document/9858144)<br>
...
* Heterogeneous Hypergraph Variational Autoencoder for Link Prediction(TPAMI, 2021)[**paper**](https://ieeexplore.ieee.org/document/9354594)<br>
* Hypergraph Convolutional Network for Group Recommendation(ICDM,2021)[**paper**](https://ieeexplore.ieee.org/document/9679118)<br>
...
* Hypergraph Transformer for Knowledge Tracing(CCWC,2024)[**paper**](https://ieeexplore.ieee.org/document/10427645)<br><br>
...
*  A Universal Subhypergraph-Assisted Embedding Framework for Both Homogeneous and Heterogeneous Networks(TKDE, 2025)[**paper**](https://ieeexplore.ieee.org/document/11045888)<br>
...
* Self-Supervised Hypergraph Training Framework via Structure-Aware Learning(TPAMI, 2025)[**paper**](https://ieeexplore.ieee.org/document/11106277)<br>
...
* Reinterpreting Hypergraph Kernels: Insights Through Homomorphism Analysis(TPAMI, 2025)[**paper**](https://ieeexplore.ieee.org/document/11159289)<br>
* A Unified Random Walk, Its Induced Laplacians and Spectral Convolutions for Deep Hypergraph Learning(TPAMI, 2025)[**paper**](https://ieeexplore.ieee.org/document/11103747)<br>
...
* Messages are Never Propagated Alone: Collaborative Hypergraph Neural Network for Time-Series Forecasting(TPAMI, 2024)[**paper**](https://ieeexplore.ieee.org/document/10314020)<br>
* Hypergraph Isomorphism Computation(TPAMI, 2024)[**paper**](https://ieeexplore.ieee.org/document/10398457)<br>
* Hypergraph Collaborative Network on Vertices and Hyperedges(TPAMI, 2023)[**paper**](https://ieeexplore.ieee.org/document/9782536)<br>
...
* Learning on Hypergraphs With Sparsity(TPAMI, 2021)[**paper**](https://ieeexplore.ieee.org/document/9001176)<br><br>
...
* Tackling higher-order relations and heterogeneity: Dynamic heterogeneous hypergraph network for spatiotemporal activity prediction(Neural Networks,2023)[**paper**](https://www.sciencedirect.com/science/article/abs/pii/S0893608023003647)<br>
* Dual-view hypergraph neural networks for attributed graph learning(knosys,2021)[**paper**](https://www.sciencedirect.com/science/article/abs/pii/S0950705121004470)<br>
* Cross-view graph contrastive learning with hypergraph对比学习(Information Fusion,2023)[**paper**](https://www.sciencedirect.com/science/article/abs/pii/S1566253523001835)<br>
* Hypergraph contrastive learning for recommendation with side information(IJICC,2024)[**paper**](https://www.sciencedirect.com/org/science/article/abs/pii/S1756378X24000062)<br>
#### 超图卷积<br>
...
* DHRL4HKG: A Dual-Hypergraph Representation Learning for Hyper-Relational Knowledge Graphs(Knowledge-Based Systems,2025)[**paper**](https://www.sciencedirect.com/science/article/pii/S0950705125009323)<br>
* Hypergraph Neural Diffusion Networks(Neural Networks,2025)[**paper**](https://www.sciencedirect.com/science/article/pii/S0893608025011529)<br>
...
* Exploring Multiple Hypergraphs for Heterogeneous Graph Neural Networks(eswa,2023)[**paper**](https://www.sciencedirect.com/science/article/abs/pii/S0957417423017323)<br>
...
* An Approximate Blow-up Lemma for Sparse Hypergraphs(Procedia Computer Science,2021)[**paper**](https://www.sciencedirect.com/science/article/pii/S1877050921021876)<br>
...
* A Survey on Hypergraph Representation Learning综述(ACM Computing Surveys,2023)[**paper**](https://dl.acm.org/doi/10.1145/3605776)<br>
#### 超图神经网络
* D-HAT: Dynamic Hypergraph Representation Learning with Attention-Based Multi-Level Hypergraph Sampling(CIKM,2025)[**paper**](https://dl.acm.org/doi/10.1145/3746252.3761102)<br>
...
* Hypergraph Motif Representation Learning(KDD,2025)[**paper**](https://dl.acm.org/doi/10.1145/3690624.3709274)<br>
...
* HySAE: An Efficient Semantic-Enhanced Representation Learning Model for Knowledge Hypergraph Link Prediction(WWW,2025)[**paper**](https://dl.acm.org/doi/10.1145/3696410.3714549)<br>
* Enhancing E-commerce Representation Learning via Hypergraph Contrastive Learning and Interpretable LLM-Driven Analysis(WWW,2025)[**paper**](https://dl.acm.org/doi/10.1145/3701716.3717579)<br>
...
* Unified Heterogeneous Hypergraph Construction for Incomplete Multimedia Recommendation(TIS,2025)[**paper**](https://dl.acm.org/doi/10.1145/3745020)<br>
* Multi-Channel Hypergraph Contrastive Learning for Matrix Completion(TIS,2025)[**paper**](https://dl.acm.org/doi/10.1145/3768319)<br>
* Towards Unified Representation Learning for Career Mobility Analysis with Trajectory Hypergraph(TIS,2024)[**paper**](https://dl.acm.org/doi/10.1145/3651158)<br>
* Fast and Accurate Temporal Hypergraph Representation for Hyperedge Prediction(KDD,2025)[**paper**](https://dl.acm.org/doi/10.1145/3690624.3709327)<br>
...
* Understanding User Perspectives for MOOC Quality Evaluation with Hypergraph Learning(TKDD,2025)[**paper**](https://dl.acm.org/doi/10.1145/3749845)<br>
* Hierarchical Structure Construction on Hypergraphs (CIKM, 2024)[**paper**](https://dl.acm.org/doi/10.1145/3627673.3679765)<br>
* A Novel Multi-view Hypergraph Adaptive Fusion Approach for Representation Learning(SENSYS,2024)[**paper**](https://dl.acm.org/doi/10.1145/3698387.3700000)<br>
...
* Multi-view Hypergraph Contrastive Policy Learning for Conversational Recommendation(SIGIR,2023)[**paper**](https://dl.acm.org/doi/10.1145/3539618.3591737)<br>
* Next Basket Recommendation with Intent-aware Hypergraph Adversarial Network(SIGIR,2023)[**paper**](https://dl.acm.org/doi/10.1145/3539618.3591742)<br>
